...
import com.example.chatbothexagonal.auth.infrastructure.adapter.in.rest.dto.LoginRequest;
import com.example.chatbothexagonal.auth.infrastructure.adapter.in.rest.dto.RegisterRequest;
...
public class AuthController {
    ...
    public ResponseEntity<AuthResponse> register(@Valid @RequestBody RegisterRequest req) {
        var result = registerUC.handle(req.email(), req.name(), req.password());
